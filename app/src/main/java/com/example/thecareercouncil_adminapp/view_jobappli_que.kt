...
class view_jobappli_que : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_view_jobappli_que)


        rv = findViewById(R.id.jobrecv)
    ...
    private fun EventchangeListener() {
        ...
        db.collection("jobque").orderBy("created", Query.Direction.DESCENDING).
