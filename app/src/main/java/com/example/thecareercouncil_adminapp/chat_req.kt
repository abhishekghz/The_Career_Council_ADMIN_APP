...
import com.example.thecareercouncil_adminapp.databinding.ActivityChatReqBinding
import com.example.thecareercouncil_adminapp.databinding.ActivityViewWorkshopBinding
import com.google.firebase.firestore.*

class chat_req : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityChatReqBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_chat_req)
        binding = ActivityChatReqBinding.inflate(layoutInflater)
    ...
    private fun EventchangeListener() {
        ...
        db.collection("Online Session Booking - Paid").orderBy("uname", Query.Direction.ASCENDING).
