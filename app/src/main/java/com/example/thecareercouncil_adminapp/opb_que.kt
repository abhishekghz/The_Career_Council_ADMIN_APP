...
class opb_que : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_opb_que)

        rv = findViewById(R.id.opbrecv)
    ...
    private fun EventchangeListener() {
        ...
        db.collection("opbque").orderBy("created", Query.Direction.DESCENDING).
