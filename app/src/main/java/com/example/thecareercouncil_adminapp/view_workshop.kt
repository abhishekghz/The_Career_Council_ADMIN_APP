...
class view_workshop : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityViewWorkshopBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_view_workshop)
        binding = ActivityViewWorkshopBinding.inflate(layoutInflater)
    ...
    private fun EventchangeListener() {
        ...
        db.collection("Workshop Request").orderBy("uname", Query.Direction.ASCENDING).
