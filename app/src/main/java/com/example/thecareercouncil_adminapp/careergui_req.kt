...
import com.example.thecareercouncil_adminapp.databinding.ActivityCareerguiReqBinding
import com.example.thecareercouncil_adminapp.databinding.ActivityOpbReqBinding
import com.google.firebase.firestore.*

class careergui_req : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityCareerguiReqBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_careergui_req)
        binding = ActivityCareerguiReqBinding.inflate(layoutInflater)
    ...
    private fun EventchangeListener() {
        ...
        db.collection(" - Paid").orderBy("uname", Query.Direction.ASCENDING).
